...
def test_distance_is_0(df):
    assert df.compute_distance(0, 0, 0, 0) == approx(0)


def test_distance_is_1_x_axis_only(df):
    assert df.compute_distance(2, 0, 1, 0) == approx(1)
...
def test_distance_is_4_x_axis_only_pos_neg(df):
    assert df.compute_distance(2, 0, -2, 0) == approx(4)


def test_distance_is_1_x_axis_only_0_to_1(df):
    assert df.compute_distance(0, 0, 1, 0) == approx(1)


def test_distance_is_1_x_axis_only_1_to_0(df):
    assert df.compute_distance(1, 0, 0, 0) == approx(1)
...
def test_distance_is_1_y_axis_only(df):
    assert df.compute_distance(0, 2, 0, 1) == approx(1)
...
def test_distance_is_4_y_axis_only_pos_neg(df):
    assert df.compute_distance(0, 2, 0, -2) == approx(4)


def test_distance_is_1_y_axis_only_0_to_1(df):
    assert df.compute_distance(0, 0, 0, 1) == approx(1)


def test_distance_is_1_y_axis_only_1_to_0(df):
    assert df.compute_distance(0, 1, 0, 0) == approx(1)
...
def test_distance_is_1_each_axis(df):
    ...
    assert df.compute_distance(2, 2, 1, 1) == approx(1.414213562)
...
def test_distance_both_axes_extreme_x(df):
    ...
    assert df.compute_distance(2, 0, 1000000000, 10) == approx(1000000000)


def test_distance_both_axes_extreme_y(df):
    # Extreme difference in y values should override the difference in x
    assert df.compute_distance(0, 0, 20, 1000000000) == approx(1000000000)


def test_distance_both_axes_shorter_than_1(df):
    assert df.compute_distance(0, 0, 0.3, 0.5) == approx(0.5830951895)
